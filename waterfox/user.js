...
// Github: https://github.com/bogachenko/freefox/tree/master/waterfox/
...
// Title: user.js
// URL: https://github.com/bogachenko/freefox/blob/master/waterfox/user.js
// Version: 56.2.5
//
...
// Waterfox Sync - remote synchronization of user data. Sync is a set of components that, using a single user account,
// remotely synchronizes data on different devices with Waterfox installed (bookmarks, history, passwords, form data, open tabs, etc.).
...
// Waterfox Sync - удаленной синхронизации пользовательских данных. Sync - набор компонентов,
// который при помощи единого пользовательского аккаунта удаленно синхронизирует данные на разных устройствах
// с установленным Waterfox (закладки, историю, пароли, данные форм, открытые вкладки и т.п.).
